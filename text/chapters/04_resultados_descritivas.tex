...
exposição baseados em medidas como o índice de Felten a estudos de plataformas
de trabalho \textit{online} --- justifica a opção metodológica por uma síntese
...
regressões por MQO (14,4\%), modelos estruturais (9,9\%), modelos teóricos
(9,8\%) e variáveis instrumentais (9,3\%); desenhos quasi-experimentais mais
exigentes em identificação causal (diferenças-em-diferenças, RDD, estudo de
